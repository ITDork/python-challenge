...
print("_________________________________________")
print("")
print("Total Gain/Loss: " + str(formattedglsum).rjust(15," "))
print(" Average Change: " + str(formattedaverage).rjust(15," "))
print("______________________________________________________________")
print(" ")
print("Greatest Gain occured " + datemaxgain + " totalling" + str(formattedmaxgain).rjust(15," "))
print("Greatest Loss occured " + datemaxloss + " totalling" + str(formattedmaxloss).rjust(15," "))
print("")
...
f.write("_________________________________________\n")
f.write("\n")      
f.write("Total Gain/Loss: " + str(formattedglsum).rjust(15," ") + "\n")
f.write(" Average Change: " + str(formattedaverage).rjust(15," ") + "\n")
f.write("______________________________________________________________\n") 
f.write("\n")
f.write("Greatest Gain occured " + datemaxgain + " totalling " + str(formattedmaxgain).rjust(15," ") + "\n")
f.write("Greatest Loss occured " + datemaxloss + " totalling " + str(formattedmaxloss).rjust(15," ") + "\n")
f.write("\n")
